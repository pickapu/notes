...
public final class ItemNoteBinding implements ViewBinding {
  ...
  private ItemNoteBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnDelete,
  ...
  public static ItemNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNoteBinding((ConstraintLayout) rootView, btnDelete, tvContent, tvTitle);
    }
