...
public abstract class Hilt_AddEditNoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditNoteFragment() {
    super();
  }

  Hilt_AddEditNoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditNoteFragment_GeneratedInjector) this.generatedComponent()).injectAddEditNoteFragment(UnsafeCasts.<AddEditNoteFragment>unsafeCast(this));
    }
  }
